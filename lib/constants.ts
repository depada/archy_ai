const RAW_PUTER_WORKER_URL = import.meta.env.VITE_PUTER_WORKER_URL || "";
export const PUTER_WORKER_URL = RAW_PUTER_WORKER_URL.replace(/\/+$/, "");

// Storage Paths
export const STORAGE_PATHS = {
  ROOT: "archy_ai",
  SOURCES: "archy_ai/sources",
  RENDERS: "archy_ai/renders",
} as const;
...
export const ARCHY_AI_RENDER_PROMPT = `
